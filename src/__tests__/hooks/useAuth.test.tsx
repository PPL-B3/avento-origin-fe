...
describe("useAuth Hook", () => {
  ...
  it("should load user from cookies if available", () => {
    (getCookie as jest.Mock).mockImplementation((key) => {
      if (key === "user") return JSON.stringify({ id: "123", email: "duljaelani@gmail.com", role: "user" });
    ...
    expect(result.current.user).toEqual({ id: "123", email: "duljaelani@gmail.com", role: "user" });
    expect(result.current.isLoading).toBe(false);
  });
